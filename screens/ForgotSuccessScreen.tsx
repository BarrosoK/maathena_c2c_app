...
const ForgotSuccessScreen = (props:any) => {
  ...
  return (
    <SafeAreaView style={styles.container}>
        <View style={styles.div}>
          ...
          <Text style={styles.paragraph}>Votre mot de passe a bien été réinitialisé.</Text>
          <TouchableOpacity style={styles.bouton} onPress={handleLoginPress}>
